...
| --- | --- | --- | --- | --- |
| v0.3.5 | 12 | 200 | 30006 | 正式版；小米 17 Ultra / Stellar 实机测试成功 |
...
3. 将已签名 APK 命名为 `MiBrowserRedirector-v<版本号>-universal.apk` 并生成同名 `.sha256`，使用该标签创建 Release，并按实际发布阶段选择正式版或 Pre-release。正文只列最多三条用户可感知的变化、已验证设备及必要升级提示，不堆测试数量或哈希表。
...
**v0.3.5 已正式发布。** 维护者反馈：小米 17 Ultra、系统 `3.0.309.0.WPACNXM.C11`、Stellar 环境下测试成功。
以下为进一步回归时使用的检查清单和空白记录模板，分别记录正常停止、故障报告与恢复结果。
